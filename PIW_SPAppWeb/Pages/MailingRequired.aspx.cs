        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    tbFromDate.Text = DateTime.Now.AddDays(-1).ToShortDateString();
                    ...
                    if (isCount(listItem, piwListInternalName))
                    {
                        ...
                        dataRow[col_PrintReqURL] =
                            listItem[piwListInternalName[Constants.PIWList_colName_PrintReqFormURL]] != null
                                ? System.TimeZone.CurrentTimeZone.ToLocalTime(DateTime.Parse(listItem[piwListInternalName[Constants.PIWList_colName_PrintReqFormURL]].ToString())).ToString()
                                : string.Empty;
            ...
            var args = new string[]
                {
                        ...
                        Constants.PIWList_FormType_StandardForm,
                        Constants.PIWList_FormType_DirectPublicationForm,
                        piwListInternalName[Constants.PIWList_colName_FOLAServiceRequired],    
