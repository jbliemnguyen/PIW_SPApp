...
<body>
    ...
    <%--<SharePoint:SPAppIFrame 
        runat="server" 
        src="https://fdc1s-sp23wfed2.ferc.gov/piw/pages/PeoplePicker.aspx?{StandardTokens}" 
        frameborder="0">
    </SharePoint:SPAppIFrame>--%>
    <SharePoint:SPAppIFrame 
        runat="server" 
        src="https://dev.spapps.ferc.gov/PIW_SPAppWeb/pages/PeoplePicker.aspx?{StandardTokens}" 
        frameborder="0">
    </SharePoint:SPAppIFrame>
